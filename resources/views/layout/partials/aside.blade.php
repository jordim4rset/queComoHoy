<nav class="menu">
    ...
    @auth
        <a href="{{ route('user.following', Auth::id()) }}"
            class="menu-item {{ request()->is('users/*/following') ? 'active' : '' }}" onclick="selectItem(this, event)">
            <span class="icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
                    <path
        ...
        <a href="{{ route('user.followers', Auth::id()) }}"
            class="menu-item {{ request()->is('users/*/followers') ? 'active' : '' }}" onclick="selectItem(this, event)">
            <span class="icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
                    <path
