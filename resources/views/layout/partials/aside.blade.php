<nav class="menu">
    ...
    @auth
   <a href="{{ route('user.following', Auth::id()) }}" class="menu-item {{ request()->is('users/*/following') ? 'active' : '' }}">
   ...
   <a href="{{ route('user.followers', Auth::id()) }}" class="menu-item {{ request()->is('users/*/followers') ? 'active' : '' }}">
